    ...
    <>
      ...
      <main className="pt-24 pb-24 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="font-serif text-4xl md:text-5xl font-bold mb-4">🚗 김해 덕운사</h1>
          <p className="text-gray-500 text-lg mb-2">📍 경남 김해시 장유면</p>
          <p className="text-gray-500 mb-8">🙏 주지: 혜원 스님 — 지역 포교·봉사 활동, 어린이 불교 교육</p>
          
          <div className="bg-gray-50 rounded-2xl p-8 mb-8">
            <h2 className="font-serif text-2xl font-bold mb-4">사찰 소개</h2>
            <p className="text-gray-700 leading-relaxed">김해 시내에서 가까운 아담하고 정갈한 사찰입니다. 바쁜 일상 속에서도 부담 없이 방문할 수 있으며, 경내가 잘 가꿔져 조용히 산책하기에도 좋습니다. 혜원 스님이 지역 주민들과 소통하며 정성스럽게 제사를 모시고 계십니다.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="rounded-2xl border-2 border-green-100 p-6">
              ...
              <ul className="space-y-2 text-gray-700">
                <li>✓ 김해 시내 근교 — 접근성 최고</li>
                <li>✓ 아담하고 정갈한 분위기</li>
                <li>✓ 경내 잘 가꿔져 산책 가능</li>
                <li>✓ 지역 포교·봉사 활동 활발</li>
                <li>✓ 주차 편리</li>
              </ul>
            </div>
            <div className="rounded-2xl border-2 border-orange-100 p-6">
              ...
              <ul className="space-y-2 text-gray-700">
                <li>• 대형 사찰 대비 규모가 작습니다</li>
                <li>• 봉안당 시설은 별도 문의가 필요합니다</li>
              </ul>
            </div>
          </div>
          ...
          <div className="rounded-2xl p-8 mb-8" style={{ backgroundColor: "#2D6A4F10" }}>
            ...
            <p className="text-sm text-gray-500 mt-2">이런 분께 추천: 바쁜 직장인, 김해·부산 거주자, 편안한 분위기를 원하는 분</p>
          </div>
