    ...
    <>
      ...
      <main className="pt-24 pb-24 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="font-serif text-4xl md:text-5xl font-bold mb-4">🌊 합천 수암사</h1>
          <p className="text-gray-500 text-lg mb-2">📍 경남 합천군 (합천호 인근)</p>
          <p className="text-gray-500 mb-8">🙏 주지: 법웅 스님 — 참선과 수행 중심, 템플스테이 운영</p>
          
          <div className="bg-gray-50 rounded-2xl p-8 mb-8">
            <h2 className="font-serif text-2xl font-bold mb-4">사찰 소개</h2>
            <p className="text-gray-700 leading-relaxed">김해 시내에서 가까운 아담하고 정갈한 사찰입니다. 바쁜 일상 속에서도 부담 없이 방문할 수 있으며, 경내가 잘 가꿔져 조용히 산책하기에도 좋습니다. 법웅 스님이 지역 주민들과 소통하며 정성스럽게 제사를 모시고 계십니다.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="rounded-2xl border-2 border-orange-100 p-6">
              ...
              <ul className="space-y-2 text-gray-700">
                <li>• 대도시에서 거리가 있습니다</li>
                <li>• 경사가 있는 산길을 올라가야 합니다</li>
              </ul>
            </div>
          </div>
          ...
          <div className="rounded-2xl p-8 mb-8" style={{ backgroundColor: "#2D6A4F10" }}>
            ...
            <p className="text-sm text-gray-500 mt-2">이런 분께 추천: 마음의 위로가 필요한 분, 자연 속 힐링을 원하는 분</p>
          </div>
