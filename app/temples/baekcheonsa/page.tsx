    ...
    <>
      ...
      <main className="pt-0 pb-0">
        ...
        <div className="relative h-[60vh] min-h-[400px] flex items-end" style={{
          backgroundImage: "url('https://blog.kakaocdn.net/dn/b0JzP3/btq6oX96i3o/7W2m4Rk8T3k1S5d1BwK4rK/img.jpg')",
          ...
          <section className="mb-16">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              ...
              <div className="rounded-2xl overflow-hidden shadow-lg">
                <img src="https://blog.kakaocdn.net/dn/xK1uP/btq6tG6E09p/9e1FmQ4G1Kj6kF5HjT4K10/img.jpg" alt="덕운사 경내" className="w-full h-[300px] object-cover" />
              </div>
            </div>
          </section>
